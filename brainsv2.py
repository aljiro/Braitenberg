...
class Braitenberg2a( Brain ):
	def __init__( self ):
		super(Braitenberg2a, self).__init__()
		self.s0 = np.array([]); # x, y, theta, Tb, E, rho
		self.state_labels = []
	...
	def dmap( self, t, h, rewards ):
		...
		wheel_force = np.array([[Fl, Fr]]) + np.random.rand(2)*0.01

		return wheel_force, []

class Braitenberg2b( Brain ):
	def __init__( self ):
		super(Braitenberg2b, self).__init__()
	...
	def dmap( self, t, h, rewards ):
		...
		wheel_force = np.array([[Fr, Fl]])

		return wheel_force, []

class Braitenberg3a( Brain ):
	def __init__( self ):
		super(Braitenberg3a, self).__init__()
		self.s0 = np.array([]); # x, y
		self.state_labels = []
	...
	def dmap( self, t, h, rewards ):
		...
		wheel_force = np.array([[1-Fl, 1-Fr]]) + np.random.rand(2)*0.01

		return wheel_force, []

class Braitenberg3b( Brain ):
	def __init__( self ):
		super(Braitenberg3b, self).__init__()
		self.s0 = np.array([]); # x, y
		self.state_labels = []
	...
	def dmap( self, t, h, rewards ):
		...
		wheel_force = np.array([[1-Fr, 1-Fl]]) + np.random.rand(2)*0.01
